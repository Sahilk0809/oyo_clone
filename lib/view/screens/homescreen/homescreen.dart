          ...
          child: Column(
            ...
            children: [
                        ...
                        child: GestureDetector(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text('+ ₹${detailModel!.hotelList1[index].tax} takes & fees',style: TextStyle(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            image: DecorationImage(
                              image: AssetImage('asset/Images/Premium1.jpeg',),
                              fit: BoxFit.cover,
                            ),
                            color: Colors.black,
                            borderRadius: BorderRadius.circular(10)
                    ...
                    ...List.generate(premium.length,(index)=>Padding(
                          ...
                          children: [
                            Column(
                              ...
                              children: [
                                ...
                                const Text('28 Jun - Today',style: TextStyle(
                                    color: Colors.grey
                                ),)
                              ],
                            ),
              ...
              SingleChildScrollView(
                ...
                child: Row(
                  children: [
                    ...List.generate(template.length,(index)=>Padding(
                      padding: const EdgeInsets.only(right: 15,top: 10,left: 10),
                      child: Container(
                        height: height*0.25,
                        width: width*0.9,
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: const Text(
                    'View all offers',style: TextStyle(
fontWeight: FontWeight.w500,
                    letterSpacing: -0.3
                  ),
                  ),
              ...
              const Row(
                ...
                children: [
                  ...
                  Text('Price per room per night',style: TextStyle(
                    color: Colors.grey,
                    fontSize: 15,
                  ),)
                ],
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Icon(Icons.format_list_numbered_rtl_sharp,color: Colors.black87,size: 20,)
                        ],
                      ),
                    ),
                  ),
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Icon(Icons.arrow_downward_outlined,color: Colors.black87,size: 20,)
                        ],
                      ),
                    ),
                  ),
                       ...
                       children: [
                         ...
                         Column(
                           ...
                           children: [
                             ...
                             const Row(
                               children: [
                                 Icon(Icons.accessibility_new,color:Colors.purple,size: 15,),
                                 Text(' Couples are welcome',style: TextStyle(
                                   color: Colors.purple,
                                 ),),
                               ],
                             ),
                             const Row(
                               children: [
                                 Icon(Icons.thumb_up_off_alt,color:Colors.purple,size: 15,),
                                 Text(' Rated high for cleanliness',style: TextStyle(
                                   color: Colors.purple,
                                 ),),
                               ],
                             ),
